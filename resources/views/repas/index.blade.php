                            ...
                            <tr class="hover:bg-surface-container-low transition-colors group">
                                <td class="px-md py-md">
                                    <div class="flex items-center gap-sm">
                                        ...
                                        <div>
                                            <p class="font-headline-md text-body-md font-bold">{{ $repas->name }}</p>
                                            <p class="text-label-sm text-on-surface-variant line-clamp-1">{{ $repas->description }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-md py-md">
                                    <span class="bg-surface-container-highest text-on-surface-variant px-sm py-1 rounded-full text-label-sm">{{ $repas->category }}</span>
                                </td>
                                <td class="px-md py-md">
                                    <div class="flex gap-xs">
                                        <span class="text-tertiary-container bg-on-tertiary-container/10 px-2 py-0.5 rounded text-[10px] font-bold uppercase">{{ $repas->ingredient }}</span>
                                    </div>
                                </td>
        ...
        <form action="{{ route('repas.store') }}" method="post" class="w-screen max-w-md side-panel-open bg-surface shadow-2xl h-full flex flex-col" enctype="multipart/form-data">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar p-gutter space-y-lg">
                ...
                <div class="space-y-sm">
                    ...
                    <input type="file" name="image" id="image" class="w-full px-md py-2.5 rounded-lg border border-outline-variant bg-surface focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" accept="image/*">
                </div>
                <!-- Basic Info -->
                <div class="space-y-sm">
                    <div>
                ...
                <div class="space-y-sm">
                    ...
                    <div>
                        ...
                        <textarea class="w-full px-md py-2.5 rounded-lg border border-outline-variant bg-surface focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all"
                            ...
                            rows="2"
                            id="ingredient"
                            name="ingredient">{{old('ingredient')}}</textarea>
